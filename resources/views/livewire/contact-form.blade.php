                    ...
                    <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                        <div class="max-w-lg mx-auto">
                            ...
                            <p class="mt-3 text-lg leading-6 text-gray-500">
                                Feel free to reach out to me using the form here.
                            </p>
...
{{--                            </p>--}}
                    ...
                    <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
                        <div class="max-w-lg mx-auto lg:max-w-none">
                            <form wire:submit.prevent="submitForm" action="/contact" class="grid grid-cols-1 row-gap-6">
                                ...
                                @endif
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            <input wire:model="name" id="name" name="name" class="@error('name')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150" placeholder="Full name">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            <input wire:model="email" id="email" type="text" name="email" class="@error('email')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150" placeholder="Email">
                                        </div>
                                        @error('email')
                                        <p class="text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
