                ...
                <form wire:submit.prevent="send" class="space-y-8" method="post">
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your
                            email</label>
                        <input type="email" name="email" wire:model.debounce.500ms="email" id="email"
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your
                            Name</label>
                        <input type="text" id="name" name="name" wire:model.debounce.500ms="name"
                    ...
                    <div>
                        ...
                        <input type="text" id="subject" name="subject" wire:model.debounce.500ms="subject"
                               class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                    ...
                    <div class="sm:col-span-2">
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your
                            message</label>
                        <textarea id="message" name="message" wire:model.debounce.500ms="message" rows="6"
                    ...
                    <div wire:loading wire:target="send">
                        <img width="50" src="{{ asset('/images/loading.gif') }}" alt="">
                    </div>
